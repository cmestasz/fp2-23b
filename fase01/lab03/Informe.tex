...
\begin{itemize}
	...
	\item \url{https://github.com/cmestasz/fp2-23b/tree/main/fase01/lab03}
	      %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\end{itemize}
...
\begin{itemize}
	...
	\item mostrarNaves() imprime todas las naves usando su método toString().
...
\lstinputlisting[language=bash, caption={DemoBatalla.java},numbers=left,]{ejec01.bash}
\lstinputlisting[language=bash, caption={Actividad2.java},numbers=left,]{ejec02.bash}
\lstinputlisting[language=bash, caption={Actividad3.java},numbers=left,]{ejec03.bash}
\pagebreak
