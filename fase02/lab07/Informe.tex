...
\section{Tarea}
\begin{itemize}
	\item \textbf{Actividad 1:} Cree un Proyecto llamado Laboratorio7
	\item \textbf{Actividad 2:} Usted deberá crear las dos clases Soldado.java y VideoJuego4.java. Puede reutilizar lo
	...
	\item \textbf{Actividad 5:} Tendrá 2 Ejércitos (utilizar la estructura de datos más adecuada). Inicializar el tablero con n
	      ...
	      creados y sus puntos de vida (usar caracteres como $\mid \_$ y otros y distinguir los de un ejército
...
\begin{itemize}
	...
	\item Arreglo bidimensional de objetos.
...
\begin{itemize}
	...
	\item \url{https://github.com/cmestasz/fp2-23b/tree/main/fase02/lab07}
	      %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\end{itemize}
...
\end{itemize}
\pagebreak
\lstinputlisting[language=Java, caption={VideoJuego4.java},numbers=left,]{VideoJuego4.java}
\begin{itemize}
	...
	\item Se crean dos copias del arreglo de soldados usando el método copiarSoldados() para demostrar los 2 ordenamientos.
